...
<ul>
	<li>GUTS version 1.2.6 is a maintenance update and fixes incompatibilities with newer CRAN requests. Package functionality was not changed.</li>
	<li>GUTS version 1.2.5 sets seed on tests that use random numbers to get deterministic testable environment. Package functionality was not changed.</li>
...
<ul>
	...
	<li>Nickisch, D., Rall, B., Singer, A., Ashauer, R. (2022). Fish Species Sensitivity Ranking Depends on Pesticide Exposure Profiles. Environmental Toxicology &amp; Chemistry, 41, 1732-1741, doi: <a href="http://dx.doi.org/10.1002/etc.5348" target="_blank">10.1002/etc.5348a</a>.</li>
	<li>Singer, A., Nickisch, D., Gergs, A. (2023). Joint survival modelling for multiple species exposed to toxicants. Science of The Total Environment, 857, 159266, doi: <a href="http://dx.doi.org/10.1016/j.scitotenv.2022.159266" target="_blank">10.1016/j.scitotenv.2022.159266</a>.</li>
</ul>
